    ...
    */
    ...
    private func configCellAtIndexPath(indexPath:NSIndexPath) -> SCMessageTableViewCell {
        ...
        if message.avatar != nil {
            cell.buttonUserAvatar.setImage(message.avatar!, forState: UIControlState.Normal)
        } else {
    ...
    */
    func didMediaButtonPress(inputView: SCMessageInputView) {
        ...
        if self.messageInputView.voiceChangeButton != nil
            && self.messageInputView.voiceChangeButton.selected {
            self.messageInputView.changeKeyboardMode()
        }
    }
    
    //点击语音按钮
    func didMessageOrVoiceButtonPress(inputView: SCMessageInputView, isShowVoice: Bool) {
