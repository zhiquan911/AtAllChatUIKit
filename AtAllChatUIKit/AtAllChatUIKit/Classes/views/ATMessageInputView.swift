...
public class ATMessageInputView: UIImageView, UITextViewDelegate {
    ...
    func setupUI() {
        ...
        textView.placeHolder = NSLocalizedString("Send New Message", bundle: Bundle.atchat_bundle, comment: "");
...
//            UIImage.loadImage(named: "voice_HL")
        ...
        if (self.allowsSendVoice) {
            ...
            button.setTitle(NSLocalizedString("按住 说话", bundle: Bundle.atchat_bundle, comment: ""), for: .normal)
            button.setTitle(NSLocalizedString("松开 结束", bundle: Bundle.atchat_bundle, comment: ""), for: .highlighted)
