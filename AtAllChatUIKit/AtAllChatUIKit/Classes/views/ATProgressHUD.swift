...
public class ATProgressHUD: UIView {
    ...
    */
    private func setupUI() {
        ...
        if(self.labelTip == nil) {
            ...
            labelTip.text = NSLocalizedString("手指上滑，取消发送", bundle: Bundle.atchat_bundle, comment: "")
    ...
    */
    private func toggleRecording(recording: Bool) {
        ...
        if recording {
            ...
            self.labelTip.text = NSLocalizedString("手指上滑，取消发送", bundle: Bundle.atchat_bundle, comment: "");
        } else {
            self.labelTip.backgroundColor = UIColor(red: 1, green: 0, blue: 0, alpha: 0.63);
            self.labelTip.text = NSLocalizedString("松开手指，取消发送", bundle: Bundle.atchat_bundle, comment: "");
        }
    }
    ...
    */
    func showMessageTooShortTip() {
        ...
        self.labelTip.backgroundColor = UIColor.clear;
        self.labelTip.text = NSLocalizedString("说话时间太短", bundle: Bundle.atchat_bundle, comment: "");
